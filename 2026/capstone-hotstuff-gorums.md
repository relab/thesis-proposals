...
Relab already has an extensive [HotStuff][3] implementation based on legacy Gorums.
This project focuses on a small implementation from first principles using current Gorums ideas.
...
Implement a minimal Chained HotStuff prototype in Go using [Gorums][4].
...
1. Read the [HotStuff paper][2], [DiemBFT paper][6] and relevant [Gorums][1] material.
...
- [DiemBFT v4: State Machine Replication in the Diem Blockchain][6]
...
[6]: https://developers.diem.com/papers/diem-consensus-state-machine-replication-in-the-diem-blockchain/2021-08-17.pdf
